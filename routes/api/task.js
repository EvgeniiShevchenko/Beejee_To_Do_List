...
var router = express.Router(); // Иницилизация сервиса базы данных

var appId = "app-gzhil";

var client = _mongodbStitchServerSdk.Stitch.initializeDefaultAppClient(appId);

var mongodb = client.getServiceClient(_mongodbStitchServerSdk.RemoteMongoClient.factory, "mongodb-atlas"); // Подключение к базе данных

var db = mongodb.db("firstApp"); // Подключение к колекции базы данных

var collection = db.collection("Task"); // Иницилизация нового пользователя
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            send_data_to_database = _context2.sent;
    ...
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 9:
            delete_task_from_database = _context3.sent;
            res.send({
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 6:
            get_data_from_database = _context4.sent;
            res.send(get_data_from_database);
            _context4.next = 13;
            break;
    ...
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 10:
            delete_task_from_database = _context5.sent;
            res.send({
